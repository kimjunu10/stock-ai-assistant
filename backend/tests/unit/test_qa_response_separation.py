...
def test_broker_opinion_target_price_only_when_stated():
    reports = [
        {
            "broker": "하나증권", "report_date": "2026-05-04", "title": "갈 길이 멀다",
            "investment_opinion": "BUY", "chunk_id": "rc1", "source_page": 1,
            "target_price": 480000, "target_price_currency": "KRW",
            "target_price_status": "stated",
        },
        {
            "broker": "키움증권", "report_date": "2026-05-04", "title": "보유",
            "investment_opinion": "보유", "chunk_id": "rc2",
            "target_price": 999999, "target_price_status": "unknown",  # 미확정
        },
    ]
...
def test_official_information_from_numeric_sources():
    ns = [
        NumericSource(
            label="영업이익", value=43_601_051_000_000, unit="원",
            period="2025 사업보고서(연간) 누적", basis="연결", value_kind="actual_value",
            source_type="financials", source_key="005930/2025/11011",
        )
    ]
